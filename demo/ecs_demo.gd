...
func _input(event: InputEvent) -> void:
	if event.is_action_pressed("ui_accept"):  # Space bar
		...
		var moving_entities = ecs_world.query([PositionComponent, VelocityComponent])
		print("\nMoving entities: %d" % moving_entities.size())
